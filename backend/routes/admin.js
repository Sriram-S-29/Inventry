...
import { list, login, newItem, newVendor, register, vendorList,itemName,itemDisplay,vendorLists,productLists,purchaseOrder,newDepartment } from '../controllers/controller.js';
admin.use(cors());
const corsOptions = {
