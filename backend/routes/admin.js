...
import { list, login, newItem, newVendor, register, vendorList,itemName,itemDisplay,vendorLists,productLists,purchaseOrder,newDepartment,getDepartmentsList,newOutgoing,itemDetail,ItemTransction,getdata } from '../controllers/controller.js';
admin.use(cors());
const corsOptions = {
